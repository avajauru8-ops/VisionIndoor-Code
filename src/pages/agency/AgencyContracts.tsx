...
export default function AgencyContracts() {
  ...
  const generatePDF = () => {
    ...
    // Header
    doc.setFontSize(18);
    doc.text('CONTRATO DE PRESTAÃ‡ÃƒO DE SERVIÃ‡OS PUBLICITÃRIOS', margin, y);
    y += 15;
    
    // Body
    doc.setFontSize(12);
    const content = `
Pelo presente instrumento, de um lado, ${profile.nome || 'AGÃŠNCIA NÃƒO CADASTRADA'}, inscrita no CPF/CNPJ ${profile.cpf_cnpj || 'N/A'}, com sede em ${profile.endereco || 'N/A'}, ${profile.cidade || 'N/A'} - ${profile.estado || 'N/A'}, doravante denominada CONTRATADA.

E, de outro lado, ${nome || 'NOME DO CLIENTE'}, inscrito(a) no CPF/CNPJ ${cpfCnpj || 'N/A'}, com sede/residÃªncia em ${endereco || 'N/A'}, doravante denominado(a) CONTRATANTE.

As partes acima identificadas tÃªm, entre si, justo e acertado o presente Contrato de PrestaÃ§Ã£o de ServiÃ§os PublicitÃ¡rios, que se regerÃ¡ pelas clÃ¡usulas seguintes e pelas condiÃ§Ãµes descritas no presente.
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-xs text-[#8b9aa5] font-medium mt-1">Gere contratos PDF rapidamente com os dados da sua agÃªncia.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
         ...
         <div className="bg-white border border-[#e8edf2] rounded-[24px] p-6 h-fit shadow-sm">
            ...
            <div className="space-y-4">
               <div>
                 <label className="block text-[10px] font-bold text-zinc-500 uppercase tracking-widest mb-2">Nome / RazÃ£o Social</label>
               ...
               <div>
                 <label className="block text-[10px] font-bold text-zinc-500 uppercase tracking-widest mb-2">EndereÃ§o Completo</label>
         ...
         <div className="bg-white rounded-[24px] border border-[#e8edf2] p-8 shadow-sm min-h-[600px] text-gray-800 font-serif text-sm">
            <h1 className="text-center font-bold text-lg mb-8 uppercase text-zinc-800">Contrato de PrestaÃ§Ã£o de ServiÃ§os PublicitÃ¡rios</h1>
